...
const GlobalTable: React.FC<Props> = ({ data }) => {
  ...
  const CustomTextField = forwardRef<HTMLInputElement, React.ComponentProps<typeof TextField>>(
    (props, ref) => {
      ...
      <TableContainer component={Paper}>
        ...
        >
          <Table sx={{ minWidth: 650 }} aria-label="simple table">
            <TableHead>
              <TableRow>
                <TableCell>Embark Name</TableCell>
                <TableCell>Steam Name</TableCell>
                <TableCell>Xbox Name</TableCell>
                <TableCell>Playstation Name</TableCell>
                <TableCell>Cashouts</TableCell>
            ...
            <TableBody>
              {visibleData.map((item, index) => (
                ...
                >
                  ...
                  <TableCell>{item.steam}</TableCell>
                  <TableCell>{item.xbox}</TableCell>
